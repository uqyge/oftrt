...
extern "C" 
{
TENSORRTAPI nvinfer1::IPluginExt* createRPNROIPlugin(int featureStride, int preNmsTop,
                                                                int nmsMaxOut, float iouThreshold, float minBoxSize,
...
//! \param eps Epsilon for not diviiding by zero.
//!
TENSORRTAPI nvinfer1::IPluginExt* createNormalizePlugin(const nvinfer1::Weights* scales, bool acrossSpatial, bool channelShared, float eps);
...
//!
TENSORRTAPI nvinfer1::IPluginExt* createPriorBoxPlugin(nvinfer1::plugin::PriorBoxParameters param);
...
//!
TENSORRTAPI nvinfer1::IPluginExt* createAnchorGeneratorPlugin(nvinfer1::plugin::GridAnchorParameters* param, int numLayers);
...
//!
TENSORRTAPI nvinfer1::IPluginExt* createNMSPlugin(nvinfer1::plugin::DetectionOutputParameters param);
...
//! \param ignoreBatch If true, all the input tensors will be treated as if their batch sizes were 1.
//!
TENSORRTAPI nvinfer1::IPluginExt* createConcatPluginV2(int concatAxis, bool ignoreBatch);
...
//! \param negSlope Negative_slope value.
//!
TENSORRTAPI nvinfer1::IPluginExt* createLReLUPlugin(float negSlope);
...
//! \param stride Strides in H and W.
//!
TENSORRTAPI nvinfer1::IPluginExt* createReorgPlugin(int stride);
...
TENSORRTAPI nvinfer1::IPluginExt* createRegionPlugin(nvinfer1::plugin::RegionParameters params);
...
//!
TENSORRTAPI void registerAllTensorRTPlugins();
} // extern "C"
